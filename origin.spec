...
%{!?commit:
%global commit bb2373273b2c7962b681124dad51c58d43ef80a1
}
%global shortcommit %(c=%{commit}; echo ${c:0:7})
# os_git_vars needed to run hack scripts during rpm builds
%{!?os_git_vars:
%global os_git_vars OS_GIT_TREE_STATE=clean OS_GIT_VERSION=v3.4.1.8 OS_GIT_COMMIT=bb23732 OS_GIT_MAJOR=3 OS_GIT_MINOR=4+
}
...
%changelog
* Thu Mar 02 2017 Jenkins CD Merge Bot <tdawson@redhat.com> 3.4.1.9
- Existing images are tagged with correct reference on push
  (miminar@redhat.com)
- UPSTREAM: 42178: stop spamming logs on restart of api server
  (decarr@redhat.com)
...
* Tue Feb 07 2017 Jenkins CD Merge Bot <tdawson@redhat.com> 3.4.1.5
- fix migration script (sjenning@redhat.com)
- Add a status function to excluder (sdodson@redhat.com)
- fix extended test compilation error introduced in backport
  (bparees@redhat.com)
- UPSTREAM: 36827: Fix recycler pod deletion race. (jsafrane@redhat.com)

* Thu Feb 02 2017 Jenkins CD Merge Bot <tdawson@redhat.com> 3.4.1.4
